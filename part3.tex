...
\input{preamble.tex}
\gr
\subtitle{Μέρος 3: Όχι μονο \en Papers\gr : Παρουσιάσεις  \& Άλλα}
...
Κάντε κλικ για να ανοίξετε το μοντέλο εγγράφου}}
\end{center}
\end{enumerate}

\begin{block}{Συμβουλές}
\begin{itemize}
\item Χρησιμοποιήστε τα περιβάλλοντα \en \bftt{enumerate}\gr και \en \bftt{itemize} \gr για λίστες.
